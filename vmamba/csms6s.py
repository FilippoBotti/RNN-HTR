...
try:
    ...
    WITH_SELECTIVESCAN_CORE = False
    # warnings.warn("Can not import selective_scan_cuda_core")
    # print("Can not import selective_scan_cuda_core", flush=True)
    # exit()
try:
    import selective_scan_cuda
except ImportError:
    WITH_SELECTIVESCAN_MAMBA = False
    # warnings.warn("Can not import selective_scan_cuda")
    # print("Can not import selective_scan_cuda", flush=True)
    # exit()
