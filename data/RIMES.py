...
import data.rimes_transform as T
...
#     self.dataset_path = json.load(f)

# # Access the value of the self.dataset_path key
# self.dataset_path = self.dataset_path['self.dataset_path']
class RIMES(Dataset):
    def __init__(
        self,
        mode,
        ...
        self.data = pickle.load(
            open(
                os.path.join(self.dataset_path, "RIMES-2011-Lines", "labels_corr.pkl"), "rb"
            )
        )
    ...
    def __getitem__(self, idx):
        ...
        # image = Image.open(
        #     os.path.join(self.dataset_path, "RIMES-2011-Lines", "Images", file + ".jpg")
        # )
        image = get_images(os.path.join(self.dataset_path, "RIMES-2011-Lines", "Images", file + ".jpg"), self.img_size[0], self.img_size[1])
...
def build_RIMES(image_set, dataset_path, args):
    transforms = make_coco_transforms(image_set, args=args)
    return RIMES(image_set, transforms, dataset_path=dataset_path, img_size=args.img_size)